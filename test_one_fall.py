...
def experiment(n, days, total_assets, init_invest_ratio, win_ratio, lose_ratio, buy_ratio):
	...
	for times in range(n):
		...
		for day in range(days):
			for i in range(stock_count):
				...
				if current_price[i][-1] < 0: # bankrupt
					# bankrupt_count += 1
					stock_num[i] = 0
					current_price[i][-1] = 0
					continue
...
final_assets, avg_trend = experiment(10000, 300, 1e9, 0.001, win_ratio, lose_ratio, buy_ratio)
...
print("our final assets: ", best_param[1])
# print("avg trend: ", best_param[2])
# final_assets, avg_trend = monkey(300, 1e9, 1, win_ratio, lose_ratio, buy_ratio)
# win_wrt_trend = final_assets - avg_trend
# best_param = [win_wrt_trend, final_assets, avg_trend, win_ratio, lose_ratio, buy_ratio]
